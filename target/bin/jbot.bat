...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="jbot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.toxin.jbot.Main %CMD_LINE_ARGS%
